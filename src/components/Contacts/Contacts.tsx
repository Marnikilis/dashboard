...
const recipients = [
  { img: av2, name: "Anna Dark", amount: "420.00" },
  { img: av5, name: "Peter Abelard", amount: "420.00" },
  { img: av6, name: "Alan Miller", amount: "420.00" },
  { img: av7, name: "Peter Parker", amount: "420.00" },
  { img: av8, name: "Malia Stiff", amount: "420.00" },
  { img: av9, name: "Tom Lee", amount: "420.00" },
  { img: av10, name: "Derek Hill", amount: "420.00" },
  { img: av11, name: "John Kile", amount: "420.00" },
  { img: av12, name: "Dakota Milk", amount: "420.00" },
];
    ...
    <div className={styles.container}>
      ...
      <div className={styles.groupContainer}>
        <div className={styles.text}>
          <span style={{ color: "#7D8DA6" }}>Group</span> Party
        </div>
